...
7. [Java array layout and 60% perf. gain]({% post_url 2026-02-21-jvm-perf-4d-tensor-p7 %})
8. [JIT: Inlining, strength reduction, unrolling]({% post_url 2026-03-29-jvm-perf-4d-tensor-p8 %})
